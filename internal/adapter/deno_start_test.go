...
func TestDenoStart_EmptyCommand(t *testing.T) {
	a := &DenoAdapter{cfg: &config.ServerConfig{Start: ""}}
	err := a.Start()
	if err == nil {
...
func TestDenoStart_Success(t *testing.T) {
	a := &DenoAdapter{
...
func TestDenoStart_InvalidCommand(t *testing.T) {
	a := &DenoAdapter{
